...
<head>
	...
	<title> EZ-FiveM Roleplay CAD - Homepage </title>
	...
	<div class="login-content-holder">
        ...
        <div class="login-form-holder">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                ...
                                <p>This Community portal is managed by EZ-FiveM Network™ and only authorized personnel can continue. <br><br> Please note your IP is <?php echo $_SERVER['REMOTE_ADDR']; ?> and all login attempts are recorded and closely monitored.</p>
                ...
                <div id="copyright" class="text-center text-white">
					...
					<small>Kamila Roxanne © 2020</small></br>

                    <small>EZ-FiveM Network™ <?php echo date("Y"); ?></small>
